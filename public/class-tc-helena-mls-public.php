...
class TC_Helena_MLS_Public {
	...
	public function update_property_listings(){
		...
		// if fewer than 100 properties, then run download properties
		if( $my_query->post_count < 100 ) {
			$this->download_listings();
			die();
		}
	...
	public static function tc_delete_scheduled_events() {
